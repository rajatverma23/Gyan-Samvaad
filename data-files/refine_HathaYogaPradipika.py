...
# ========= CONFIG =========
csv_path = "HathaYogaPradipika.csv"
output_jsonl = "HathaYogaPradipika.jsonl"

TYPE_VALUE = "Yoga-Questions-based-Hatha-Yoga-Pradipika"
...
with open(output_jsonl, "w", encoding="utf-8") as f:
    for idx, row in df.iterrows():
        record = {
            ...
            "Reference": f'{row["Reference_Link"].strip()} Page Number: {row["Page_Number"]} Sutra Number: {row["Sutra"]}'
        }
